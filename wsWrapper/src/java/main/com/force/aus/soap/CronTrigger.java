    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CronExpression", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cronExpression;
    @XmlElementRef(name = "EndTime", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "NextFireTime", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> nextFireTime;
    ...
    @XmlElementRef(name = "PreviousFireTime", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> previousFireTime;
    ...
    @XmlElementRef(name = "TimesTriggered", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> timesTriggered;
     ...
     *     
     */
    public JAXBElement<String> getCronExpression() {
     ...
     *     
     */
    public void setCronExpression(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getNextFireTime() {
        return nextFireTime;
    }
     ...
     *     
     */
    public void setNextFireTime(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getPreviousFireTime() {
     ...
     *     
     */
    public void setPreviousFireTime(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<Integer> getTimesTriggered() {
     ...
     *     
     */
    public void setTimesTriggered(JAXBElement<Integer> value) {
