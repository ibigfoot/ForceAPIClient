 ...
 *       &lt;sequence>
 *         &lt;element name="assignmentRuleId" type="{urn:enterprise.soap.sforce.com}ID"/>
...
@XmlRootElement(name = "AssignmentRuleHeader", namespace = "urn:enterprise.soap.sforce.com")
public class AssignmentRuleHeader {

    @XmlElement(namespace = "urn:enterprise.soap.sforce.com", required = true, nillable = true)
    protected String assignmentRuleId;
    @XmlElement(namespace = "urn:enterprise.soap.sforce.com", required = true, type = Boolean.class, nillable = true)
