...
/**
 * <p>Java class for ContentDocumentFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}ContentDocument" minOccurs="0"/>
...
@XmlType(name = "ContentDocumentFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<ContentDocument> parent;
     ...
     *     
     */
    public JAXBElement<ContentDocument> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<ContentDocument> value) {
        this.parent = value;
    }
