...
/**
 * <p>Java class for ForecastShare complex type.
 * 
 ...
 *         &lt;element name="CanSubmit" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "ForecastShare", propOrder = {
    "accessLevel",
    "canSubmit",
    "lastModifiedBy",
    "lastModifiedById",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CanSubmit", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> canSubmit;
    ...
    /**
     * Gets the value of the canSubmit property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getCanSubmit() {
        return canSubmit;
    }

    /**
     * Sets the value of the canSubmit property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setCanSubmit(JAXBElement<Boolean> value) {
