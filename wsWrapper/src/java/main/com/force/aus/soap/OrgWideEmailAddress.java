...
/**
 * <p>Java class for OrgWideEmailAddress complex type.
 * 
 ...
 *         &lt;element name="IsAllowAllProfiles" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "OrgWideEmailAddress", propOrder = {
    "address",
    "createdBy",
    "createdById",
    "createdDate",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "DisplayName", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> displayName;
    @XmlElementRef(name = "IsAllowAllProfiles", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isAllowAllProfiles;
    ...
    /**
     * Gets the value of the isAllowAllProfiles property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getIsAllowAllProfiles() {
        return isAllowAllProfiles;
    }

    /**
     * Sets the value of the isAllowAllProfiles property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setIsAllowAllProfiles(JAXBElement<Boolean> value) {
        this.isAllowAllProfiles = value;
    }
