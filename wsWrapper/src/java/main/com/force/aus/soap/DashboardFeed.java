...
/**
 * <p>Java class for DashboardFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Dashboard" minOccurs="0"/>
...
@XmlType(name = "DashboardFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Dashboard> parent;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Dashboard }{@code >}
     *     
     */
    public JAXBElement<Dashboard> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Dashboard> value) {
        this.parent = value;
    }
