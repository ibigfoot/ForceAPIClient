...
/**
 * <p>Java class for DashboardComponentFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}DashboardComponent" minOccurs="0"/>
...
@XmlType(name = "DashboardComponentFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<DashboardComponent> parent;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DashboardComponent }{@code >}
     *     
     */
    public JAXBElement<DashboardComponent> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<DashboardComponent> value) {
        this.parent = value;
    }
