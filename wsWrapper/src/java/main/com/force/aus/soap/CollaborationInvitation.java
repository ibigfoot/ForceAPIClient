    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "InvitedUserEmail", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> invitedUserEmail;
    @XmlElementRef(name = "InvitedUserEmailNormalized", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> invitedUserEmailNormalized;
    @XmlElementRef(name = "InviterId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> inviterId;
    ...
    @XmlElementRef(name = "OptionalMessage", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optionalMessage;
    ...
    @XmlElementRef(name = "SharedEntityId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sharedEntityId;
     ...
     *     
     */
    public void setInvitedUserEmail(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getInvitedUserEmailNormalized() {
     ...
     *     
     */
    public void setInvitedUserEmailNormalized(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getInviterId() {
        return inviterId;
    }
     ...
     *     
     */
    public void setInviterId(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getOptionalMessage() {
     ...
     *     
     */
    public void setOptionalMessage(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getSharedEntityId() {
     ...
     *     
     */
    public void setSharedEntityId(JAXBElement<String> value) {
