 ...
 *         &lt;element name="CacheControl" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CacheControl", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cacheControl;
