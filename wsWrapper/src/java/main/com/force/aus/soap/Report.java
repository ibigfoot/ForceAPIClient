    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "LastRunDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> lastRunDate;
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getLastRunDate() {
        return lastRunDate;
    }
     ...
     *     
     */
    public void setLastRunDate(JAXBElement<XMLGregorianCalendar> value) {
