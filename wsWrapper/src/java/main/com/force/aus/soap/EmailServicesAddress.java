    ...
    extends SObject
{
    ...
    protected JAXBElement<String> emailDomainName;
    @XmlElementRef(name = "Function", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<EmailServicesFunction> function;
    @XmlElementRef(name = "FunctionId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "LocalPart", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> localPart;
    @XmlElementRef(name = "RunAsUserId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> runAsUserId;
     ...
     *     
     */
    public void setEmailDomainName(JAXBElement<String> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link EmailServicesFunction }{@code >}
     *     
     */
    public JAXBElement<EmailServicesFunction> getFunction() {
        return function;
    }
     ...
     *     
     */
    public void setFunction(JAXBElement<EmailServicesFunction> value) {
        this.function = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getLocalPart() {
        return localPart;
    }
     ...
     *     
     */
    public void setLocalPart(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getRunAsUserId() {
        return runAsUserId;
    }
     ...
     *     
     */
    public void setRunAsUserId(JAXBElement<String> value) {
