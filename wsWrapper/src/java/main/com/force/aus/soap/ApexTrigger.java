    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "UsageAfterDelete", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageAfterDelete;
    @XmlElementRef(name = "UsageAfterInsert", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageAfterInsert;
    @XmlElementRef(name = "UsageAfterUndelete", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageAfterUndelete;
    @XmlElementRef(name = "UsageAfterUpdate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageAfterUpdate;
    @XmlElementRef(name = "UsageBeforeDelete", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageBeforeDelete;
    @XmlElementRef(name = "UsageBeforeInsert", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> usageBeforeInsert;
    @XmlElementRef(name = "UsageBeforeUpdate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
