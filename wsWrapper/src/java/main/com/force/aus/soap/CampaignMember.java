    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "FirstRespondedDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> firstRespondedDate;
    @XmlElementRef(name = "HasResponded", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
