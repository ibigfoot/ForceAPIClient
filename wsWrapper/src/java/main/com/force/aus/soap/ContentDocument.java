    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ArchivedById", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> archivedById;
    @XmlElementRef(name = "ArchivedDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> archivedDate;
    ...
    @XmlElementRef(name = "LatestPublishedVersion", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<ContentVersion> latestPublishedVersion;
    @XmlElementRef(name = "LatestPublishedVersionId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> latestPublishedVersionId;
     ...
     *     
     */
    public JAXBElement<String> getArchivedById() {
        return archivedById;
    }
     ...
     *     
     */
    public void setArchivedById(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getArchivedDate() {
        return archivedDate;
    }
     ...
     *     
     */
    public void setArchivedDate(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<ContentVersion> getLatestPublishedVersion() {
     ...
     *     
     */
    public void setLatestPublishedVersion(JAXBElement<ContentVersion> value) {
     ...
     *     
     */
    public JAXBElement<String> getLatestPublishedVersionId() {
     ...
     *     
     */
    public void setLatestPublishedVersionId(JAXBElement<String> value) {
