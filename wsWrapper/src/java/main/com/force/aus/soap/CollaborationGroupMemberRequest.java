...
/**
 * <p>Java class for CollaborationGroupMemberRequest complex type.
 * 
 ...
 *         &lt;element name="RequesterId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "CollaborationGroupMemberRequest", propOrder = {
    "collaborationGroup",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "RequesterId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> requesterId;
    @XmlElementRef(name = "ResponseMessage", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getRequesterId() {
        return requesterId;
    }
     ...
     *     
     */
    public void setRequesterId(JAXBElement<String> value) {
