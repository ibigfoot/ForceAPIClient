...
/**
 * <p>Java class for UserFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}User" minOccurs="0"/>
...
@XmlType(name = "UserFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<User> parent;
     ...
     *     
     */
    public JAXBElement<User> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<User> value) {
        this.parent = value;
    }
