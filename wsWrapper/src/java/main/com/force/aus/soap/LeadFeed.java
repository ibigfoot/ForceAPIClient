...
/**
 * <p>Java class for LeadFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Lead" minOccurs="0"/>
...
@XmlType(name = "LeadFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Lead> parent;
     ...
     *     
     */
    public JAXBElement<Lead> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Lead> value) {
        this.parent = value;
    }
