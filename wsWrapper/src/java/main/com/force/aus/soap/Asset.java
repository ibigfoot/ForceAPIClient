    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsCompetitorProduct", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Product2", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Product2> product2;
    @XmlElementRef(name = "Product2Id", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> product2Id;
    @XmlElementRef(name = "PurchaseDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SerialNumber", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
