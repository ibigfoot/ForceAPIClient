    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "NotifyForFields", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> notifyForFields;
    @XmlElementRef(name = "NotifyForOperations", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> notifyForOperations;
    @XmlElementRef(name = "Query", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getNotifyForFields() {
     ...
     *     
     */
    public void setNotifyForFields(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getNotifyForOperations() {
     ...
     *     
     */
    public void setNotifyForOperations(JAXBElement<String> value) {
