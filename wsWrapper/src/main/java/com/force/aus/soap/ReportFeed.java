...
/**
 * <p>Java class for ReportFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Report" minOccurs="0"/>
...
@XmlType(name = "ReportFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Report> parent;
     ...
     *     
     */
    public JAXBElement<Report> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Report> value) {
        this.parent = value;
    }
