 ...
 *         &lt;element name="MetadataContainerMember" type="{urn:sobject.enterprise.soap.sforce.com}MetadataContainerMember" minOccurs="0"/>
 *         &lt;element name="MetadataContainerMemberId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CompilerErrors", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ErrorMsg", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorMsg;
    @XmlElementRef(name = "IsCheckOnly", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "IsRunTests", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "MetadataContainerMember", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<MetadataContainerMember> metadataContainerMember;
    @XmlElementRef(name = "MetadataContainerMemberId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
