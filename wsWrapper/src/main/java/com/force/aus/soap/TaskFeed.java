...
/**
 * <p>Java class for TaskFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Task" minOccurs="0"/>
...
@XmlType(name = "TaskFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Task> parent;
     ...
     *     
     */
    public JAXBElement<Task> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Task> value) {
        this.parent = value;
    }
