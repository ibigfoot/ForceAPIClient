 ...
 *       &lt;sequence>
 *         &lt;element name="CanHaveGuests" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CanHaveGuests", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> canHaveGuests;
    @XmlElementRef(name = "CollaborationType", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> collaborationType;
    ...
    @XmlElementRef(name = "GroupMemberRequests", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<QueryResultType> groupMemberRequests;
    @XmlElementRef(name = "GroupMembers", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<QueryResultType> groupMembers;
    @XmlElementRef(name = "HasPrivateFieldsAccess", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> hasPrivateFieldsAccess;
    @XmlElementRef(name = "InformationBody", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> informationBody;
    @XmlElementRef(name = "InformationTitle", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> informationTitle;
    @XmlElementRef(name = "LastFeedModifiedDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> lastFeedModifiedDate;
    ...
    @XmlElementRef(name = "MemberCount", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the canHaveGuests property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getCanHaveGuests() {
        return canHaveGuests;
    }

    /**
     * Sets the value of the canHaveGuests property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setCanHaveGuests(JAXBElement<Boolean> value) {
        this.canHaveGuests = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getCollaborationType() {
     ...
     *     
     */
    public void setCollaborationType(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<QueryResultType> getGroupMemberRequests() {
     ...
     *     
     */
    public void setGroupMemberRequests(JAXBElement<QueryResultType> value) {
     ...
     *     
     */
    public JAXBElement<QueryResultType> getGroupMembers() {
        return groupMembers;
    }
     ...
     *     
     */
    public void setGroupMembers(JAXBElement<QueryResultType> value) {
     ...
     *     
     */
    public JAXBElement<Boolean> getHasPrivateFieldsAccess() {
     ...
     *     
     */
    public void setHasPrivateFieldsAccess(JAXBElement<Boolean> value) {
     ...
     *     
     */
    public JAXBElement<String> getInformationBody() {
     ...
     *     
     */
    public void setInformationBody(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getInformationTitle() {
     ...
     *     
     */
    public void setInformationTitle(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getLastFeedModifiedDate() {
     ...
     *     
     */
    public void setLastFeedModifiedDate(JAXBElement<XMLGregorianCalendar> value) {
