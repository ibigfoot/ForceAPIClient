...
/**
 * <p>Java class for ContactFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Contact" minOccurs="0"/>
...
@XmlType(name = "ContactFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Contact> parent;
     ...
     *     
     */
    public JAXBElement<Contact> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Contact> value) {
        this.parent = value;
    }
