    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsStandard", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PricebookEntries", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<QueryResultType> pricebookEntries;
     ...
     *     
     */
    public JAXBElement<QueryResultType> getPricebookEntries() {
     ...
     *     
     */
    public void setPricebookEntries(JAXBElement<QueryResultType> value) {
