 ...
 *         &lt;element name="items" type="{urn:enterprise.soap.sforce.com}DescribeSoftphoneLayoutItem" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DescribeSoftphoneLayoutSection", namespace = "urn:enterprise.soap.sforce.com", propOrder = {
    "entityApiName",
    "items"
})
