 ...
 *         &lt;element name="ExecutableEntity" type="{urn:sobject.enterprise.soap.sforce.com}sObject" minOccurs="0"/>
 *         &lt;element name="ExecutableEntityId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ActionScript", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> actionScript;
    @XmlElementRef(name = "ActionScriptType", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ExecutableEntity", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<SObject> executableEntity;
    @XmlElementRef(name = "ExecutableEntityId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "IsDumpingHeap", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isDumpingHeap;
    @XmlElementRef(name = "Iteration", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Line", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<SObject> getExecutableEntity() {
     ...
     *     
     */
    public void setExecutableEntity(JAXBElement<SObject> value) {
