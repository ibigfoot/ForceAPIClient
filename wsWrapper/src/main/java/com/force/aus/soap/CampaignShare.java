...
/**
 * <p>Java class for CampaignShare complex type.
 * 
 ...
 *         &lt;element name="CampaignAccessLevel" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "CampaignShare", propOrder = {
    "campaign",
    "campaignAccessLevel",
    "campaignId",
    "isDeleted",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CampaignAccessLevel", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> campaignAccessLevel;
     ...
     *     
     */
    public JAXBElement<String> getCampaignAccessLevel() {
     ...
     *     
     */
    public void setCampaignAccessLevel(JAXBElement<String> value) {
