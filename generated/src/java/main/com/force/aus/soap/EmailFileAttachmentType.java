...
@XmlType(name = "EmailFileAttachment", namespace = "urn:enterprise.soap.sforce.com", propOrder = {
    "body",
    "contentType",
    "fileName",
    "inline"
...
public class EmailFileAttachmentType {
    ...
    @XmlElementRef(name = "body", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
