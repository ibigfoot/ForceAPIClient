    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "TeamTemplateMemberId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> teamTemplateMemberId;
     ...
     *     
     */
    public JAXBElement<String> getTeamTemplateMemberId() {
     ...
     *     
     */
    public void setTeamTemplateMemberId(JAXBElement<String> value) {
