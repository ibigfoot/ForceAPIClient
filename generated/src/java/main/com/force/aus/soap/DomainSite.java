...
/**
 * <p>Java class for DomainSite complex type.
 * 
 ...
 *         &lt;element name="Domain" type="{urn:sobject.enterprise.soap.sforce.com}Domain" minOccurs="0"/>
 *         &lt;element name="DomainId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "DomainSite", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "domain",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Domain> domain;
    @XmlElementRef(name = "DomainId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PathPrefix", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pathPrefix;
     ...
     *     
     */
    public JAXBElement<Domain> getDomain() {
        return domain;
    }
     ...
     *     
     */
    public void setDomain(JAXBElement<Domain> value) {
        this.domain = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getPathPrefix() {
        return pathPrefix;
    }
     ...
     *     
     */
    public void setPathPrefix(JAXBElement<String> value) {
