    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "PermissionsCreateMultiforce", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PermissionsInstallMultiforce", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PermissionsPublishMultiforce", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
